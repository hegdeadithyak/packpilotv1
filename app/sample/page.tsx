...
export default function SamplePage() {
  ...
  useEffect(() => {
    const initializeSample = async () => {
      try {
        // Create and load sample workspace
    ...
    initializeSample();
  }, [createWorkspace, loadWorkspace, loadSampleData, initializePhysics]);
    ...
    return (
      <div className="h-screen bg-[#0f0f10] text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold mb-2">Loading Sample Workspace...</h1>
          <p className="text-primary">Initializing 30+ sample boxes and physics engine</p>
        </div>
      </div>
    );
  }
